...
import 'package:community_app/screens/password_reset_screen.dart';
      ...
      body: SafeArea(
        child: Container(
          padding: MediaQuery.of(context).size.width >
                  webScreenSize //need padding from both side
              ? EdgeInsets.symmetric(
                  horizontal: MediaQuery.of(context).size.width / 3)
              : const EdgeInsets.symmetric(horizontal: 32),
          width: double.infinity, //need full width
          child: Column(
            crossAxisAlignment:
                CrossAxisAlignment.center, //all content should be in center
            children: [
              Flexible(
                child: Container(),
                flex: 2,
